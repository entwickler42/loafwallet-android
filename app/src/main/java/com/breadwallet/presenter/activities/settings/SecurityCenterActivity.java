...
//            Log.e(TAG, "getView: pos: " + position + ", item: " + items.get(position));
    ...
    private void updateList() {
        ...
        itemList.clear();
        itemList.add(new BRSecurityCenterItem("6-Digit PIN", "Unlocks your LoafWallet, authorizes send money.",
        ...
        if (Utils.isFingerprintAvailable(this)) {
            itemList.add(new BRSecurityCenterItem("FingerPrint", "Unlocks your LoafWallet, authorizes send money to set limit.",
        ...
        itemList.add(new BRSecurityCenterItem("Paper Key", "Restores your LoafWallet on new devices and after software updates.",
